      ...
      <div className="mx-auto max-w-[1460px]">
        ...
        <div>
          {projects.map((project, index) => (
            <article
              key={project.title}
              className="group grid gap-8 border-b border-[var(--line)] py-12 lg:grid-cols-[0.62fr_1.38fr] lg:gap-16 lg:py-16"
            >
              <div className="flex flex-col justify-between gap-10 lg:py-3">
                <div>
                  <div className="mb-8 flex items-center justify-between">
                    <span className="text-sm font-bold">{project.number}</span>
              ...
              <a
                ...
                className={`relative overflow-hidden border border-[var(--line)] bg-[var(--paper)] p-3 sm:p-5 ${
